  ...
  argTypes: {
    cioClient: {
      description: [
        ...
        '',
        '`clientId?: string` — Unique browser/app identifier (sent as `i` when provided).',
        '',
        '`sessionId?: number` — Session number (sent as `s` when provided).',
        '',
        '`userId?: string` — Anonymized logged-in user identifier (sent as `ui` when provided).',
        '',
        '`segments?: string[]` — User segments for targeting (sent as `us` when provided).',
        '',
