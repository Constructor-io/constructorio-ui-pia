...
function Input({ value: providedValue, placeholder, disabled = false, onSubmit, onFocus, translations, }) {
    ...
    const resolvedPlaceholder = translations?.['Ask anything'] !== undefined
        ? translate('Ask anything', translations)
        : (placeholder ?? translate('Ask anything'));
    return (React.createElement("div", { className: 'cio-pia-input-container' },
        React.createElement("input", { type: 'text', value: value, onChange: (e) => setValue(e.target.value), onKeyDown: handleSubmitOnEnter, onFocus: onFocus, placeholder: resolvedPlaceholder, disabled: disabled, className: 'cio-pia-input' }),
        React.createElement("button", { type: 'button', onClick: handleSubmit, className: 'cio-pia-send-button', disabled: disabled },
