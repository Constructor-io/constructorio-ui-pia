...
class MockAgent {
    ...
    async getSuggestedQuestions({ itemId, variationId, threadId, parameters = {}, }) {
        if (!itemId)
    ...
    async getAnswerResults({ itemId, variationId, threadId, question, parameters = {}, }) {
        if (!itemId)
            throw new Error('Item ID is required');
        if (!question)
    ...
    async getAnswerResultsStream({ itemId, threadId, variationId, question, parameters, onStart, onMessage, onEnd, }) {
        if (!itemId)
            throw new Error('Item ID is required');
        if (!question)
            throw new Error('Question is required');
